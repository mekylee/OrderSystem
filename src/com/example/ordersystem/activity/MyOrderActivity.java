   ...
   protected void onCreate(Bundle savedInstanceState) {
	...
	private void init() {
		...
		myoder_listview.setAdapter(new SimpleAdapter(this, getData(), R.layout.myorder_listview_item, 
				new String[]{"number_of_dishes","status_of_order","dish_img","dish_name","dish_per_price","dish_total_price"},
				new int[]{R.id.number_of_dished_tv,R.id.status_order_tv,R.id.myorder_img,R.id.dish_name_tv,R.id.dish_price_tv,R.id.total_price_tv}));
